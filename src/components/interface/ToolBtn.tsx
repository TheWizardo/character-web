export default function ToolBtn({ onClick, children, gold, active, style, disabled }: {
  onClick: () => void; children: React.ReactNode; gold?: boolean; active?: boolean, style?: any; disabled?: boolean
}) {
  return (
    <button
      onClick={onClick}
