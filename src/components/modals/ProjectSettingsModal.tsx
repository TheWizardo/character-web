...
export default function ProjectSettingsModal({
  ...
  return (<SettingsModal title="Story Settings" secondaryTitle={project.name} additionalInfo={`${characterCount} character${characterCount !== 1 ? "s" : ""} · ${connectionCount} connection${connectionCount !== 1 ? "s" : ""}`} tabs={TABS} currentTab={tab} onClose={onClose} setTab={setTab}>
    <>
      {/* ── GENERAL TAB ──────────────────────────────── */}
      {tab === "general" && (
